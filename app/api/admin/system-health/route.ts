...
export async function GET(req:NextRequest){
 ...
 try{
  ...
  const modules=[
   ...
   {id:'payment_webhook',label:'Payment webhook',state:paymentWebhook?'ok':'optional',detail:paymentWebhook?'Endpoint payment_paid idempotent đã được bảo vệ bằng secret':'Adapter thanh toán sẵn sàng; cần PAYMENT_WEBHOOK_SECRET khi kết nối cổng thanh toán',count:null},
