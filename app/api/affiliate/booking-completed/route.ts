...
export async function POST(req:NextRequest){
 ...
 // Authenticate from headers/cookies before parsing attacker-controlled JSON. The
 // route intentionally supports both a signed external webhook and same-origin
 // authenticated Admin completion.
