...
export async function POST(req:NextRequest){
 ...
 try{
  const burstAllowed=await consumePublicRateLimit(sql,{key:publicRateKey(req,'affiliate-login'),action:'affiliate.login.submit',scope:'affiliate-login-ip',maxHits:30,windowMinutes:15});
