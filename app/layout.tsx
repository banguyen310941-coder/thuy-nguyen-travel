...
export const metadata: Metadata = {
  ...
  other:{'x-ui-version':'stabilization-v8-checkout-20260823'}
};
export default function RootLayout({children}:Readonly<{children:React.ReactNode}>){return <html lang="vi"><body data-ui-version="stabilization-v8-checkout-20260823"><SiteChrome>{children}</SiteChrome></body></html>}
