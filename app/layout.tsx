...
export const metadata: Metadata = {
  ...
  other: { 'x-ui-version': 'mobile-v3-viewport-20260822' },
};

export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="vi"><body data-ui-version="mobile-v3-viewport-20260822"><SiteChrome>{children}</SiteChrome></body></html>;
}
