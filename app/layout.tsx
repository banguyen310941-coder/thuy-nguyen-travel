...
export default async function RootLayout({children}:Readonly<{children:React.ReactNode}>){
 ...
 return <html lang="vi"><body id="top" data-ui-version="happygo-public-sanitized-20260906-prod"><script type="application/ld+json">{JSON.stringify(organization)}</script><MarketingAttributionCapture/><PwaRegister/><SiteChrome initialSettings={site}>{children}</SiteChrome></body></html>;
}
