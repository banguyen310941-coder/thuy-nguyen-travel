...
export async function generateMetadata():Promise<Metadata>{
 ...
 return {
  ...
  twitter:{card:'summary_large_image',title,description,...(image?{images:[image]}:{})},other:{'mobile-web-app-capable':'yes','x-ui-version':'happygo-public-visuals-pwa-20260906-prod'}
 };
}
