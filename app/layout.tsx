...
export const metadata: Metadata = {metadataBase:new URL('https://happygo.vn'),title:{default:'HappyGo Travel',template:'%s | HappyGo Travel'},description:'HappyGo Travel - Tour, villa, khách sạn, resort và du thuyền toàn quốc. Hành trình hạnh phúc, kết nối yêu thương.',applicationName:'HappyGo Travel',keywords:['HappyGo Travel','du lịch','tour du lịch','villa resort','khách sạn','du thuyền','happygo.vn'],openGraph:{title:'HappyGo Travel',description:'Hành trình hạnh phúc, kết nối yêu thương. Tour, villa, khách sạn và du thuyền toàn quốc.',type:'website',siteName:'HappyGo Travel',url:'https://happygo.vn'},other:{'x-ui-version':'happygo-brand-v1-20260831'}};
