...
import {AdminNotificationSoundMonitor} from '@/components/AdminNotificationSoundMonitor';
...
export default function AdminLayout({children}:{children:React.ReactNode}){return <><PortalWorkspaceBar scope="admin" status="Production"/><AdminStorageGuard/><AdminSeoGuideSeedSync/><AdminSeoDemoSeeder/><AdminTourSeedSync/><AdminNotificationSoundMonitor/><AdminPushNotifications/>{children}</>}
