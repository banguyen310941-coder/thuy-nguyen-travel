...
export default async function HomePage(){
 ...
 return <><link rel="preload" as="image" href={heroImage} fetchPriority="high"/><LegacyAdminPwaRedirect/><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(website)}}/><HomeCmsHero initialCms={home}/><HomeCmsSections initialHome={home} initialProducts={products} initialTours={cmsTours} initialArticles={articles}/></>
}
