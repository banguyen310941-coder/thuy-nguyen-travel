...
export function AdminAffiliateApplications(){
 ...
 return <section className="admin-panel affiliate-application-queue">
  <div className="admin-panel-head"><div><small>CTV · HỒ SƠ ĐĂNG KÝ MỚI</small><h2>CTV chờ duyệt</h2><p>Hồ sơ chỉ được vận hành sau khi Admin kích hoạt.</p></div><span className="affiliate-application-count">{items.length} chờ duyệt</span></div>
