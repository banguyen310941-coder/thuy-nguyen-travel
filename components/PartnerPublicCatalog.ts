...
export type PartnerPublicProduct={id:string;partnerId:string;partnerName:string;type:'Villa & Resort'|'Khách sạn'|'Du thuyền'|'Tour du lịch';name:string;slug:string;place:string;address:string;price:string;summary:string;cover:string;gallery:string;amenities:string;policies:string;checkin:string;checkout:string;unitsText:string;status:string;updatedAt:string;category?:string;serviceStars?:string;duration?:string;boarding?:string;departure?:string;route?:string;airline?:string;transport?:string;departures?:string;itinerary?:string;highlights?:string;included?:string;excluded?:string;promotions?:string;childrenPolicy?:string;extraCharge?:string;content?:string;faq?:string};
