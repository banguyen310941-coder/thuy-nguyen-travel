...
const tabs:TabItem[]=[{id:'overview',label:'Tổng quan',hint:'Việc chờ xử lý',area:'all'},{id:'partners',label:'Đối tác',hint:'Hồ sơ & sản phẩm',area:'partners'},{id:'support',label:'Hỗ trợ',hint:'Trao đổi đối tác',area:'partners'},{id:'affiliates',label:'CTV / Affiliate',hint:'Hồ sơ & hoa hồng',area:'affiliates'}];
