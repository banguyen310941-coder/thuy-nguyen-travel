...
export function GuideArticleEditable({post}:{post:StaticPost}){
 ...
 return <article className="public-article seo-static-article seo-guide-v2">
  ...
  <figure className="seo-guide-cover-wrap"><img className="article-cover seo-guide-cover" src={image} alt={post.coverAlt}/><figcaption>{post.coverAlt}</figcaption></figure>
