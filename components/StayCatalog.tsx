...
export function StayCatalog(){
  ...
  const filtered=useMemo(()=>stays.filter(stay=>{
    ...
    const matchType=type==='all'||(type==='villa'&&(t==='villa'||t==='resort'))||(type==='hotel'&&t==='khách sạn')||(type==='resort'&&t==='resort');
  ...
  const label=typeParam==='villa'?'Villa & Resort':typeParam==='hotel'?'Khách sạn':'Lưu trú toàn quốc';
