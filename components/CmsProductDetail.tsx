...
export type PublicProduct={id:string;type:string;name:string;slug:string;place:string;price:string;pricingBasis?:PricingBasis;status:string;summary:string;cover:string;gallery:string;rating:string;category:string;serviceStars?:number|string;address:string;latitude?:number|string|null;longitude?:number|string|null;checkin:string;checkout:string;amenities:string;amenityTags?:string[];amenityDetails?:Record<string,string>;policies:string;childrenPolicy:string;extraCharge:string;extraPersonFee?:string;earlyCheckinFee?:string;lateCheckoutFee?:string;earlyLatePolicy?:string;duration:string;pickup:string;boarding:string;itinerary:string;content:string;seoTitle?:string;seoDescription?:string;units:PublicProductUnit[];unitsText?:string;departure?:string;route?:string;airline?:string;transport?:string;departures?:string;included?:string;excluded?:string;highlights?:string;promotions?:string};
